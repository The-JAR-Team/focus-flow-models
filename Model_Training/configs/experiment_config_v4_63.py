# engagement_hf_trainer/configs/experiment_config_v4_63.py
...
MODEL_PARAMS = {
    "hidden_dim": 256,
    "num_gru_layers": 2,
    "dropout_rate": 0.5,  # Increased significantly from 0.25
...
# Focus: Balanced boost to less engaged
CLASSIFICATION_CLASS_WEIGHTS = torch.tensor([1.0, 1.4, 1.3, 1.6, 0.8], dtype=torch.float32)
CLASSIFICATION_LOSS_FN = nn.CrossEntropyLoss(weight=CLASSIFICATION_CLASS_WEIGHTS)

# --- Paths and Naming ---
BASE_OUTPUT_DIR = "./training_runs_output/"
EXPERIMENT_NAME = "multitask_v4_63" # Focus: Very High Dropout, Moderate Augmentation (v4_5 aug)
