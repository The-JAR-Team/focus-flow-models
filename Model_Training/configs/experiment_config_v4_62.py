# engagement_hf_trainer/configs/experiment_config_v4_62.py
...
TRAINING_HYPERPARAMS = {
    ...
    "metric_for_best_model": "eval_mae", # Or eval_accuracy if classification is primary
...
MODEL_PARAMS = {
    ...
    "regression_loss_weight": 0.75,  # Was 1.0
    "classification_loss_weight": 0.75,  # Increased from 0.5
}
NUM_COORDINATES = 3

# --- Loss Functions ---
REGRESSION_LOSS_FN = nn.MSELoss()
# Focus: Different Class Weights
CLASSIFICATION_CLASS_WEIGHTS = torch.tensor([1.2, 1.8, 1.0, 1.5, 0.7], dtype=torch.float32)
CLASSIFICATION_LOSS_FN = nn.CrossEntropyLoss(weight=CLASSIFICATION_CLASS_WEIGHTS)

# --- Paths and Naming ---
BASE_OUTPUT_DIR = "./training_runs_output/"
EXPERIMENT_NAME = "multitask_v4_62" # Focus: Emphasize Classification Loss, Different Class Weights

# --- Data Augmentation Parameters ---
MESH_FLIP_MAP = mesh_annotations_derived_flip_map
# Data Augmentation: Same as v4_5
