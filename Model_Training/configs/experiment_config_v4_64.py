# engagement_hf_trainer/configs/experiment_config_v4_64.py
...
MODEL_PARAMS = {
    "hidden_dim": 256,
    "num_gru_layers": 2,
    "dropout_rate": 0.30, # Moderate dropout
...
EXPERIMENT_NAME = "multitask_v4_64" # Focus: Aug - More Rotation & Temporal, Less Noise/Scale/Flip

# --- Data Augmentation Parameters ---
MESH_FLIP_MAP = mesh_annotations_derived_flip_map
# Focus: More Rotation & Temporal, Less Noise/Scale/Flip
DATA_AUGMENTATION_PARAMS = {
    "add_noise_prob": 0.2,  # Reduced
    "noise_std": 0.002,  # Reduced
    "random_scale_prob": 0.2,  # Reduced
    "scale_range": (0.98, 1.02),  # Reduced
    "random_rotate_prob": 0.7,  # Increased significantly
    "max_rotation_angle_deg": 20.0,  # Increased significantly
    "random_flip_prob": 0.1,  # Reduced
    "landmark_flip_map": MESH_FLIP_MAP,
    "temporal_jitter_prob": 0.5,  # Increased significantly
    "jitter_burst_length_range": (5, 15),  # Increased significantly
    "jitter_magnitude_std": 0.1,  # Increased significantly
    "max_jitter_bursts_per_sequence": 3,  # Increased
    "verbose": False
}
