# engagement_hf_trainer/configs/experiment_config_v4_61.py
...
TRAINING_HYPERPARAMS = {
    ...
    "learning_rate": 4e-5,  # Increased from 3e-5
    "warmup_ratio": 0.15,
...
MODEL_PARAMS = {
    "hidden_dim": 256,
    "num_gru_layers": 2,
    "dropout_rate": 0.20,  # Reduced from 0.25
...
CLASSIFICATION_CLASS_WEIGHTS = torch.tensor([1.0, 1.2, 1.5, 1.8, 0.8], dtype=torch.float32) # Same as v4_5
CLASSIFICATION_LOSS_FN = nn.CrossEntropyLoss(weight=CLASSIFICATION_CLASS_WEIGHTS)

# --- Paths and Naming ---
BASE_OUTPUT_DIR = "./training_runs_output/"
EXPERIMENT_NAME = "multitask_v4_61" # Focus: Less Aggressive Aug, Higher LR, More Weight Decay

# --- Data Augmentation Parameters ---
MESH_FLIP_MAP = mesh_annotations_derived_flip_map
# Focus: Less Aggressive Augmentation (Reduced from v4_5)
DATA_AUGMENTATION_PARAMS = {
    "add_noise_prob": 0.3, # Was 0.5
    "noise_std": 0.003, # Was 0.004
    "random_scale_prob": 0.3, # Was 0.4
    "scale_range": (0.97, 1.03), # Was (0.95, 1.05)
    "random_rotate_prob": 0.3, # Was 0.4
    "max_rotation_angle_deg": 7.0, # Was 10.0
    "random_flip_prob": 0.2, # Was 0.3
    "landmark_flip_map": MESH_FLIP_MAP,
    "temporal_jitter_prob": 0.2, # Was 0.3
    "jitter_burst_length_range": (2, 8), # Was (3,10)
    "jitter_magnitude_std": 0.03, # Was 0.05
    "max_jitter_bursts_per_sequence": 1, # Was 2
    "verbose": False
}
