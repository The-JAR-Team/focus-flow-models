# engagement_hf_trainer/configs/experiment_config_v4_68.py
...
# Focus: More balanced class weights
CLASSIFICATION_CLASS_WEIGHTS = torch.tensor([1.1, 1.3, 1.3, 1.3, 0.8], dtype=torch.float32)
CLASSIFICATION_LOSS_FN = nn.CrossEntropyLoss(weight=CLASSIFICATION_CLASS_WEIGHTS)

# --- Paths and Naming ---
BASE_OUTPUT_DIR = "./training_runs_output/"
EXPERIMENT_NAME = "multitask_v4_68" # Focus: Balanced Augmentation (all probs moderate), higher dropout

# --- Data Augmentation Parameters ---
MESH_FLIP_MAP = mesh_annotations_derived_flip_map
# Focus: Balanced Augmentation - all probs moderate
DATA_AUGMENTATION_PARAMS = {
    "add_noise_prob": 0.4, "noise_std": 0.004,
    "random_scale_prob": 0.4, "scale_range": (0.95, 1.05),
    "random_rotate_prob": 0.4, "max_rotation_angle_deg": 10.0,
    "random_flip_prob": 0.4, # Increased from v4_5's 0.3
    "landmark_flip_map": MESH_FLIP_MAP,
    "temporal_jitter_prob": 0.4, # Increased from v4_5's 0.3
    "jitter_burst_length_range": (3, 10), # Same as v4_5
    "jitter_magnitude_std": 0.05, # Same as v4_5
    "max_jitter_bursts_per_sequence": 2, # Same as v4_5
    "verbose": False
}
