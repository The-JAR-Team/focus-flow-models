# engagement_hf_trainer/configs/experiment_config_v4_6.py
...
# Example: LOAD_INITIAL_WEIGHTS_PATH: Optional[str] = "./training_runs_output/multitask_v4_5/final_exported_models/model.safetensors"
...
MODEL_PARAMS = {
    "hidden_dim": 256,
    "num_gru_layers": 2,
    "dropout_rate": 0.35,  # Increased from 0.25
...
# Focus: Boost 'Barely Engaged'
CLASSIFICATION_CLASS_WEIGHTS = torch.tensor([1.0, 1.5, 1.2, 1.8, 0.8], dtype=torch.float32)
CLASSIFICATION_LOSS_FN = nn.CrossEntropyLoss(weight=CLASSIFICATION_CLASS_WEIGHTS)

# --- Paths and Naming ---
BASE_OUTPUT_DIR = "./training_runs_output/"
EXPERIMENT_NAME = "multitask_v4_6" # Focus: Stronger Augmentation + Increased Dropout

# --- Data Augmentation Parameters ---
MESH_FLIP_MAP = mesh_annotations_derived_flip_map
# Focus: Stronger Augmentation
DATA_AUGMENTATION_PARAMS = {
    "add_noise_prob": 0.6,  # Was 0.5 in v4_5
    "noise_std": 0.005,  # Was 0.004 in v4_5
    "random_scale_prob": 0.5,  # Was 0.4 in v4_5
    "scale_range": (0.92, 1.08),  # Was (0.95, 1.05) in v4_5
    "random_rotate_prob": 0.5,  # Was 0.4 in v4_5
    "max_rotation_angle_deg": 15.0,  # Was 10.0 in v4_5
    "random_flip_prob": 0.4,  # Was 0.3 in v4_5
    "landmark_flip_map": MESH_FLIP_MAP,
    "temporal_jitter_prob": 0.4,  # Was 0.3 in v4_5
    "jitter_burst_length_range": (4, 12),  # Was (3, 10) in v4_5
    "jitter_magnitude_std": 0.07,  # Was 0.05 in v4_5
    "max_jitter_bursts_per_sequence": 3,  # Was 2 in v4_5
    "verbose": False
}
...
if __name__ == '__main__':
    ...
    # ... (rest of the __main__ block from v4_5.py can be copied here if needed for direct execution)
