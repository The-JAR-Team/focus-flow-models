# engagement_hf_trainer/configs/experiment_config_v4_66.py
...
EXPERIMENT_NAME = "multitask_v4_66" # Focus: Minimal Static Aug, Max Temporal Jitter

# --- Data Augmentation Parameters ---
MESH_FLIP_MAP = mesh_annotations_derived_flip_map
# Focus: Minimal Static Augmentation, Max Temporal Jitter
DATA_AUGMENTATION_PARAMS = {
    "add_noise_prob": 0.1,  # Minimal
    "noise_std": 0.001,  # Minimal
    "random_scale_prob": 0.1,  # Minimal
    "scale_range": (0.99, 1.01),  # Minimal
    "random_rotate_prob": 0.1,  # Minimal
    "max_rotation_angle_deg": 5.0,  # Minimal
    "random_flip_prob": 0.1,  # Minimal
    "landmark_flip_map": MESH_FLIP_MAP,
    "temporal_jitter_prob": 0.8,  # Maximal
    "jitter_burst_length_range": (5, 20),  # Maximal
    "jitter_magnitude_std": 0.15,  # Maximal
    "max_jitter_bursts_per_sequence": 4,  # Maximal
    "verbose": False
}
