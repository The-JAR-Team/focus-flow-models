# engagement_hf_trainer/configs/experiment_config_v4_65.py
...
TRAINING_HYPERPARAMS = {
    ...
    "learning_rate": 2e-5,  # Lowered from 3e-5
    "warmup_ratio": 0.20,  # Increased from 0.15
    "weight_decay": 0.02,
...
# Focus: Stronger Class Weights for Low Engagement
CLASSIFICATION_CLASS_WEIGHTS = torch.tensor([1.5, 2.0, 1.0, 1.2, 0.7], dtype=torch.float32)
CLASSIFICATION_LOSS_FN = nn.CrossEntropyLoss(weight=CLASSIFICATION_CLASS_WEIGHTS)

# --- Paths and Naming ---
BASE_OUTPUT_DIR = "./training_runs_output/"
EXPERIMENT_NAME = "multitask_v4_65" # Focus: Lower LR, Longer Warmup, Stronger Low Engagement Class Weights
