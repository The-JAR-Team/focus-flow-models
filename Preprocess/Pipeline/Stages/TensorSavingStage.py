...
class TensorSavingStage(PipelineStage):
    ...
    def process(self, tensor_stacking_result: TensorStackingResult, verbose=True):
        ...
        """
        # Retrieve clip_folder from the result.
        ...
        # Build the save directory including the pipeline version.
        save_dir = os.path.join(self.cache_root, "PipelineResult", self.pipeline_version, subfolder)
